...
def handle_message(message):
    ...
    if chat_id in user_state:
        ...
        if text == "ℹ️ Інформація":
        ...
        elif text == "📖 Інструкція по оплаті":
            # ✅ Відправляємо текст або файл
            bot.send_message(chat_id, "📖 Інструкція по оплаті:\n1️⃣ Виберіть курс і нажмить кнопку купити.\n2️⃣ Переведіть вказану суму на карту і нажміть кнопку *✅ Я оплатив.\n3️⃣ Після цього адмін зможе прийняти оплату і бот автоматично видасть силку (підтвердження оплати від адміна може зайняти час).\n\nЯкщо є запитання то пишіть адміну")
            # 📂 Якщо треба файл:
            ...
            bot.send_message(
                chat_id,
                f"""💳 Сплати *{course['price']} грн* на карту: `4441 1144 3331 5890`
