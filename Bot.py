...
def handle_message(message):
    ...
    if chat_id in user_state:
        ...
        if text == "ℹ️ Інформація":
            ...
            bot.send_message(chat_id, "📖 Інструкція для покупки:\n1️⃣ Вибири курс і нажми кнопку купити .\n2️⃣ Сплати грошы на вказану карту і після оплати нажми кнопку ✅ Я оплатив.\n3️⃣ Адміну прийде заявка, він перевіить оплату, після підтвердженя адміна, бот автоматично видасть посилання до вибраного курсу.\n\n Якщо є запитання пишіть Адміну")
            # 📂 Якщо треба файл:
